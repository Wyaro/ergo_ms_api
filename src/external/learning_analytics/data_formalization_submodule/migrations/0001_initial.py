# Generated by Django 5.1.6 on 2025-04-04 11:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning_analytics_data_formalization_submodule.speciality', verbose_name='Специальность')),
            ],
            options={
